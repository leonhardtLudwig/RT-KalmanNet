# -*- coding: utf-8 -*-
"""
FROZEN COPY of the professor's ORIGINAL RT-KalmanNet network, kept as the
"existing robust KalmanNet" baseline for the Task-4 comparison. Do NOT modify —
the current (proposed) network lives in RT_KalmanNet_nn.py. See docs/ for the
