...
#
# FROZEN COPY of the professor's ORIGINAL RobustKalman, kept as the matched pair
# for the "existing robust KalmanNet" baseline (Task-4). Do NOT modify -- the
# current (proposed) filter lives in robust_kalman.py. The only change vs the
# teacher's file is the import below, which points at the original network.
